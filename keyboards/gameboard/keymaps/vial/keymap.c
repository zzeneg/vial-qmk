...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_F9,   KC_F12, KC_PSCR, KC_ENT,  MO(1),   KC_LALT,  KC_SPC,
        KC_LEFT, KC_UP,   KC_RGHT, KC_DOWN, XXXXXXX
    ),

    [1] = LAYOUT(
                 KC_GRV,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_F1,   KC_TAB,     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
        KC_F2,   _______,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,
        KC_F3,   _______,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,
        XXXXXXX, XXXXXXX, QK_BOOT, KC_BSPC, _______,  KC_DEL,  KC_SPC,
