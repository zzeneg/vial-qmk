...
void init_screen_home(void) {
    ...
    lv_obj_t *label_trio = lv_label_create(screen_home);
    lv_label_set_text(label_trio, "trio");
#if LV_FONT_MONTSERRAT_48
    lv_obj_set_style_text_font(label_trio, &lv_font_montserrat_48, LV_PART_MAIN);
#endif
